...
# 
# connection point peripheral_master
# 
add_interface peripheral_master axi start
set_interface_property peripheral_master associatedClock clock
set_interface_property peripheral_master associatedReset reset_n_in
set_interface_property peripheral_master readIssuingCapability 4
set_interface_property peripheral_master writeIssuingCapability 4
set_interface_property peripheral_master combinedIssuingCapability 4
set_interface_property peripheral_master ENABLED true
set_interface_property peripheral_master EXPORT_OF ""
set_interface_property peripheral_master PORT_NAME_MAP ""
set_interface_property peripheral_master SVD_ADDRESS_GROUP ""

add_interface_port peripheral_master axm_peripheral_AWID awid Output 8
add_interface_port peripheral_master axm_peripheral_AWLEN awlen Output 4
add_interface_port peripheral_master axm_peripheral_AWSIZE awsize Output 3
add_interface_port peripheral_master axm_peripheral_AWADDR awaddr Output 40
add_interface_port peripheral_master axm_peripheral_AWBURST awburst Output 2
add_interface_port peripheral_master axm_peripheral_BREADY bready Output 1
add_interface_port peripheral_master axm_peripheral_ARVALID arvalid Output 1
add_interface_port peripheral_master axm_peripheral_AWLOCK awlock Output 2
add_interface_port peripheral_master axm_peripheral_BID bid Input 8
add_interface_port peripheral_master axm_peripheral_ARREADY arready Input 1
add_interface_port peripheral_master axm_peripheral_AWCACHE awcache Output 4
add_interface_port peripheral_master axm_peripheral_BRESP bresp Input 2
add_interface_port peripheral_master axm_peripheral_RREADY rready Output 1
add_interface_port peripheral_master axm_peripheral_AWPROT awprot Output 3
add_interface_port peripheral_master axm_peripheral_BVALID bvalid Input 1
add_interface_port peripheral_master axm_peripheral_RID rid Input 8
add_interface_port peripheral_master axm_peripheral_AWVALID awvalid Output 1
add_interface_port peripheral_master axm_peripheral_ARID arid Output 8
add_interface_port peripheral_master axm_peripheral_RDATA rdata Input 256
add_interface_port peripheral_master axm_peripheral_AWREADY awready Input 1
add_interface_port peripheral_master axm_peripheral_ARADDR araddr Output 40
add_interface_port peripheral_master axm_peripheral_RRESP rresp Input 2
add_interface_port peripheral_master axm_peripheral_WID wid Output 8
add_interface_port peripheral_master axm_peripheral_ARLEN arlen Output 4
add_interface_port peripheral_master axm_peripheral_RLAST rlast Input 1
add_interface_port peripheral_master axm_peripheral_WDATA wdata Output 256
add_interface_port peripheral_master axm_peripheral_ARSIZE arsize Output 3
add_interface_port peripheral_master axm_peripheral_RVALID rvalid Input 1
add_interface_port peripheral_master axm_peripheral_WSTRB wstrb Output 32
add_interface_port peripheral_master axm_peripheral_ARBURST arburst Output 2
add_interface_port peripheral_master axm_peripheral_WLAST wlast Output 1
add_interface_port peripheral_master axm_peripheral_ARLOCK arlock Output 2
add_interface_port peripheral_master axm_peripheral_WVALID wvalid Output 1
add_interface_port peripheral_master axm_peripheral_ARCACHE arcache Output 4
add_interface_port peripheral_master axm_peripheral_WREADY wready Input 1
add_interface_port peripheral_master axm_peripheral_ARPROT arprot Output 3
