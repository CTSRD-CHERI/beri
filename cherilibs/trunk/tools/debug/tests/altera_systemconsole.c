...
CuSuite* SystemConsoleParsingSuite()
{
	CuSuite* suite = CuSuiteNew();

	SUITE_ADD_TEST(suite, ChooseQuartusParser);

	SUITE_ADD_TEST(suite, ParseQuartus12);
	SUITE_ADD_TEST(suite, ParseDevPathV12);

	SUITE_ADD_TEST(suite, ParseQuartus13);
	SUITE_ADD_TEST(suite, ParseDevPathV13);
