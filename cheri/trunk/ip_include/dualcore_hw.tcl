...
# 
# connection point debug_source 0
# 
add_interface debug_source_0 avalon_streaming start
set_interface_property debug_source_0 associatedClock clock
set_interface_property debug_source_0 associatedReset reset_n_in
set_interface_property debug_source_0 dataBitsPerSymbol 8
set_interface_property debug_source_0 errorDescriptor ""
set_interface_property debug_source_0 firstSymbolInHighOrderBits true
set_interface_property debug_source_0 maxChannel 0
set_interface_property debug_source_0 readyLatency 0
set_interface_property debug_source_0 ENABLED true
set_interface_property debug_source_0 EXPORT_OF ""
set_interface_property debug_source_0 PORT_NAME_MAP ""
set_interface_property debug_source_0 SVD_ADDRESS_GROUP ""

add_interface_port debug_source_0 debug_stream_sources_0_stream_out_data data Output 8
add_interface_port debug_source_0 debug_stream_sources_0_stream_out_valid valid Output 1
add_interface_port debug_source_0 debug_stream_sources_0_stream_out_ready ready Input 1


# 
# connection point debug_sink 0
# 
add_interface debug_sink_0 avalon_streaming end
set_interface_property debug_sink_0 associatedClock clock
set_interface_property debug_sink_0 associatedReset reset_n_in
set_interface_property debug_sink_0 dataBitsPerSymbol 8
set_interface_property debug_sink_0 errorDescriptor ""
set_interface_property debug_sink_0 firstSymbolInHighOrderBits true
set_interface_property debug_sink_0 maxChannel 0
set_interface_property debug_sink_0 readyLatency 0
set_interface_property debug_sink_0 ENABLED true
set_interface_property debug_sink_0 EXPORT_OF ""
set_interface_property debug_sink_0 PORT_NAME_MAP ""
set_interface_property debug_sink_0 SVD_ADDRESS_GROUP ""

add_interface_port debug_sink_0 debug_stream_sinks_0_stream_in_data data Input 8
add_interface_port debug_sink_0 debug_stream_sinks_0_stream_in_valid valid Input 1
add_interface_port debug_sink_0 debug_stream_sinks_0_stream_in_ready ready Output 1


# 
# connection point debug_source 1
# 
add_interface debug_source_1 avalon_streaming start
set_interface_property debug_source_1 associatedClock clock
set_interface_property debug_source_1 associatedReset reset_n_in
set_interface_property debug_source_1 dataBitsPerSymbol 8
set_interface_property debug_source_1 errorDescriptor ""
set_interface_property debug_source_1 firstSymbolInHighOrderBits true
set_interface_property debug_source_1 maxChannel 0
set_interface_property debug_source_1 readyLatency 0
set_interface_property debug_source_1 ENABLED true
set_interface_property debug_source_1 EXPORT_OF ""
set_interface_property debug_source_1 PORT_NAME_MAP ""
set_interface_property debug_source_1 SVD_ADDRESS_GROUP ""

add_interface_port debug_source_1 debug_stream_sources_1_stream_out_data data Output 8
add_interface_port debug_source_1 debug_stream_sources_1_stream_out_valid valid Output 1
add_interface_port debug_source_1 debug_stream_sources_1_stream_out_ready ready Input 1


# 
# connection point debug_sink 1
# 
add_interface debug_sink_1 avalon_streaming end
set_interface_property debug_sink_1 associatedClock clock
set_interface_property debug_sink_1 associatedReset reset_n_in
set_interface_property debug_sink_1 dataBitsPerSymbol 8
set_interface_property debug_sink_1 errorDescriptor ""
set_interface_property debug_sink_1 firstSymbolInHighOrderBits true
set_interface_property debug_sink_1 maxChannel 0
set_interface_property debug_sink_1 readyLatency 0
set_interface_property debug_sink_1 ENABLED true
set_interface_property debug_sink_1 EXPORT_OF ""
set_interface_property debug_sink_1 PORT_NAME_MAP ""
set_interface_property debug_sink_1 SVD_ADDRESS_GROUP ""

add_interface_port debug_sink_1 debug_stream_sinks_1_stream_in_data data Input 8
add_interface_port debug_sink_1 debug_stream_sinks_1_stream_in_valid valid Input 1
add_interface_port debug_sink_1 debug_stream_sinks_1_stream_in_ready ready Output 1
...
add_interface_port memory_master axm_memory_WSTRB wstrb Output 32
...
add_interface_port memory_master axm_memory_RDATA rdata Input 256
add_interface_port memory_master axm_memory_WDATA wdata Output 256
