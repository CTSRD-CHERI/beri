...
add_interface_port memory_master axm_memory_WSTRB wstrb Output 8
...
add_interface_port memory_master axm_memory_RDATA rdata Input 64
add_interface_port memory_master axm_memory_WDATA wdata Output 64
