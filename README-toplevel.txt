...
This release is intended to support simulation of the BERI1/BERI2
processors rather than FPGA synthesis, although you can use the parts
included to generate Verilog.  A future release will also include project
files usable with Altera's Quartus tools.
